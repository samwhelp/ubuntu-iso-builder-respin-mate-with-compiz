...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-mate-with-compiz/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-mate-with-compiz/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-mate-with-compiz/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-mate-with-compiz](https://github.com/samwhelp/ubuntu-iso-builder-respin-mate-with-compiz)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-mate-with-compiz.git
```


> change dir to `ubuntu-iso-builder-respin-mate-with-compiz`

``` sh
cd ubuntu-iso-builder-respin-mate-with-compiz
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-mate-with-compiz/dist`
